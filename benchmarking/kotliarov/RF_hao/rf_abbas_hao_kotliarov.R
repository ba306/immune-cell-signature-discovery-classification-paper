...
db_genes= read_excel(path ="N:./immunsig_scripts_manuscript/gene_lists_papers/abbas_2005.xlsx",sheet = 1)
...
# 1     95.52 95.64 99.08       98.58    98.18    95.58
...
# Sensitivity   PPV   NPV Specificity Accuracy f1_score
# 1       83.05 84.36 94.48       92.09    91.08     83.7
